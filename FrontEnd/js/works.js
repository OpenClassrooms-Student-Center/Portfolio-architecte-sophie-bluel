...
for (let category = 0; category < maListCategories.length; category++) {
    const itemFilter = createElement("li", {
        "class": "filter__item",
        "data-id": maListCategories[category].name
    });
    // Value to my button
...
// FAIRE UN FILTRE SUIVANT LE CLICK DU BOUTON ET EN RECHERCHANT AVEC UN DATA-ID
const boutonFilter = document.querySelector(".filter__item");
