...
/**
 * création et ajout la classe CSS de "bouton_actif" au premier bouton de la liste filterButtons.
 * setAttribute : méthode qui permet de spécifier n’importe quel attribut (le nom de l'attribut : class, sa valeur : bouton_actif).
 */
...
for (let i = 0; i < filterButtons.length; i++) {
    filterButtons[i].addEventListener("click", function () {
        ...
        * À chaque itération, la classe CSS "bouton_actif" est supprimée de chaque bouton.
        ...
        */
        ...
        /**
         * la classe CSS "bouton_actif" est ajoutée au bouton actuellement cliqué en utilisant.
