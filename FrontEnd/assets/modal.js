...
//********************** OUVERTURE/FERMETURE/ SWITCH  MODAL *****/
 export function OpenCloseSwitchModal (){
...
export function AffichageImage(element){

element.addEventListener('change',(file) =>{
...
export function trashButton() {document.querySelectorAll('.fa-trash-can').forEach((element, index)=>{
...
export function formUplaodSubmit() {
